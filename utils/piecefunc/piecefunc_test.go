...
func TestCustomFunc(t *testing.T) {
	...
	require.Equal(maxVal-18446704-18446703, f(maxVal-18446704-16))
	require.Equal(maxVal-18446704, f(maxVal-18446704-15))
	require.Equal(maxVal-18446704, f(maxVal-1))
	require.Equal(maxVal, f(maxVal))
	require.Equal(maxVal, f(math.MaxUint64))
}
